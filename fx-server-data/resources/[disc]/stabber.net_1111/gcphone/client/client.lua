...
function ShowNoPhoneWarning ()
  ...
  exports['rootNotify']:showNotification('error', 'You should get a phone first', 'Warning', 1500)
end
...
AddEventHandler("gcPhone:historiqueCall", function(historique)
  SendNUIMessage({event = 'CallHistory', historique = historique})
end)
...
function requestHistoriqueCall()
  TriggerServerEvent('gcPhone:CallHistory')
end

function appelsDeleteHistorique (num)
  TriggerServerEvent('gcPhone:DeleteCallHistory', num)
end

function appelsDeleteAllHistorique ()
  TriggerServerEvent('gcPhone:DeleteAllCallHistory')
end
...
RegisterNUICallback('DeleteAllCallHistory', function (data, cb)
