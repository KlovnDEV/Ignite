    ...
    while true do
        ...
        if useColors then
		    if fps > 0 and fps < 12 then
		        displayText("~y~FPS: ~r~" .. fps, 0, 255, 255, 255, 255, 0.22, 0.865)
		    elseif fps > 0 and fps < 30 then
		        displayText("~y~FPS: ~o~" .. fps, 0, 255, 255, 255, 255, 0.22, 0.865)
		    elseif fps > 0 and fps < 1000 then
		        displayText("~y~FPS: ~g~" .. fps, 0, 255, 255, 255, 255, 0.22, 0.865)
		    end
		else
		    if fps > 0 and fps < 1000 then
		        displayText("~c~FPS: " .. fps, 0, 255, 255, 255, 255, 0.94, 0.91)
		    end
		end
    end
end)
