Locales['en'] = {
  ...
  ['citizen_wear'] = 'Restore Skin',
  ['police_wear'] = 'Police Uniform',
  ['gilet_wear'] = 'Orange Reflective Jacket',
  ['bullet_wear'] = 'Remove Bulletproof vest',
  ...
  ['shop_item'] = '$%s',
  ['vehicleshop_title'] = 'Police Garage',
  ['vehicleshop_confirm'] = 'Take out?',
  ['vehicleshop_bought'] = '~y~%s~s~ Taken out for',
  ['vehicleshop_money'] = '',
  ...
  -- Vehicle interaction
  ['vehicle_info'] = 'Registration Information',
  ['pick_lock'] = 'Break into Vehicle',
  ['vehicle_unlocked'] = 'Vehicle ~g~Unlocked~s~!',
  ['no_vehicles_nearby'] = 'You are not by a vehicle!',
  ...
  -- Traffic interaction
  ['traffic_interaction'] = 'Object Spawner',
  ['cone'] = 'Cone',
  ['barrier'] = 'Barrier',
  ['spikestrips'] = 'Spike Strip',
  ['box'] = 'Empty Box',
  ['cash'] = 'Box of Cash',
  -- ID Card Menu
  ['name'] = 'name: %s',
