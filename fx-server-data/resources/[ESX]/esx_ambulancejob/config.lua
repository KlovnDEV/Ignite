...
--	},
	{
		model = 'police',
		label = 'CVPI Manager Paramedic'
	},
--	{
--		model = 'sheriff2',
--		label = 'Tahoe Doctor & Surgeon'
--	},
--	{
--		model = 'fire1',
--		label = 'Exp Manager Doctor & Surgeon'
--	},
--	{
--		model = '17silverado',
--		label = 'Silverado EMS Director'
--	}
...
Config.Zones = {
	...
	HospitalInteriorInside1 = {
		Pos	= { x = 274.66, y = -1360.91, z = 24.54 },
		Type = -1
	},
	...
	HospitalInteriorExit1 = {
		Pos	= { x = 254.12, y = -1372.7, z = 24.4018 },
		Type =  1
	},
