...
Config.Size 			= {x = 1.5, y = 1.5, z = 0.25}
...
Config.timer =  25000 -- Time it takes to wash money. The * amount will determine if its hours, second, or minutes.

Config.Zones = {

	laundryMat = {
		Pos = {
			{x = 1122.35 , y = -3194.49 , z = -40.4 },
