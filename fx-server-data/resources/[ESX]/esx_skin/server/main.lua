...
AddEventHandler('esx_skin:save', function(skin)
	...
	-- Custom mod
	MySQL.Async.execute("INSERT INTO outfits (idSteam) VALUES (@identifier)", { ['@identifier'] = xPlayer.identifier })
end)
...
-- Commands
TriggerEvent('es:addGroupCommand', 'skinmenu', 'admin', function(source, args, user)
