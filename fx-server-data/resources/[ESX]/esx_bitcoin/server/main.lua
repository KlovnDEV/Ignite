		...
		if PlayersSellingKoda[source] then
			...
			if poochQuantity == 0 then
				...
				if CopsConnected == 0 then
					xPlayer.addAccountMoney('black_money', math.ceil(math.random(900,1300)))
					TriggerClientEvent('esx:showNotification', source, _U('vendeste_sacos'))
				elseif CopsConnected == 1 then
					xPlayer.addAccountMoney('black_money', math.random(900,1300) + 150)
					TriggerClientEvent('esx:showNotification', source, _U('vendeste_sacos'))
				elseif CopsConnected == 2 then
					xPlayer.addAccountMoney('black_money', math.random(900,1300) + 250)
					TriggerClientEvent('esx:showNotification', source, _U('vendeste_sacos'))
				elseif CopsConnected == 3 then
					xPlayer.addAccountMoney('black_money', math.random(900,1300) + 350)
					TriggerClientEvent('esx:showNotification', source, _U('vendeste_sacos'))
				elseif CopsConnected == 4 then
					xPlayer.addAccountMoney('black_money', math.random(900,1300) + 450)
					TriggerClientEvent('esx:showNotification', source, _U('vendeste_sacos'))
				elseif CopsConnected >= 5 then
					xPlayer.addAccountMoney('black_money', math.random(1000,2500) + 550)
					TriggerClientEvent('esx:showNotification', source, _U('vendeste_sacos'))
				end
