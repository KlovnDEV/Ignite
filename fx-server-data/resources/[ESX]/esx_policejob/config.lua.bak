...
Config.AuthorizedVehicles = {
	Shared = {
		...
		-- { model = 'police', label = 'Police Interceptor I', price = 0 },
                { model = 'police2', label = 'Police Interceptor II', price = 0 },
                { model = 'police3', label = 'Police Interceptor III', price = 0 }
	},
	...
	sergeant = {
		{ model = 'fbi', label = 'Undercover Vehicle', price = 0},
