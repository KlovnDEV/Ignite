...
Config.DoorList = {
	...
	{
                authorizedJobs = {'police', 'ballas'},
                locked = false,
                maxDistance = 3,
                objHash = GetHashKey('v_ilev_fa_frontdoor'),
                objHeading = 180.0,
                objCoords = vector3(-14.29, -1441.83, 31.10),
                textCoords = vector3(-14.29, -1441.83, 31.10)

        },


	-- Vice City Cartel Door Entity
	{
		authorizedJobs = {'police', 'grove'},
		locked = false,
		maxDistance = 3,
		objHash = GetHashKey('v_ilev_fh_frontdoor'),
		objHeading = 153.0,
		objCoords = vector3(7.91, 539.08, 176.03),
		textCoords = vector3(8.33, 539.56, 176.03)
