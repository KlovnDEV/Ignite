...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -214.61, y = -1318.73, z = 29.89 },
	...
	Garage = {
		Pos   = { x = -227.35, y = -1327.75, z = 29.89 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 255, g = 0, b = 0 },
		Type  = 1,
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -167.89, y = -1306.86, z = 31.08, },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = -205, y = 1318.43, z = 29.89 },
