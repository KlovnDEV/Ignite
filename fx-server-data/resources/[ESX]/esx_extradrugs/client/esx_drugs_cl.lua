...
AddEventHandler('esx_extradrugs:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_extradrugs:hasExitedMarker', function(zone)

        CurrentAction = nil
        ESX.UI.Menu.CloseAll()

        TriggerServerEvent('esx_extradrugs:stopHarvestCoke')
        TriggerServerEvent('esx_extradrugs:stopTransformCoke')
        TriggerServerEvent('esx_extradrugs:stopSellCoke')
        TriggerServerEvent('esx_extradrugs:stopHarvestMeth')
        TriggerServerEvent('esx_extradrugs:stopTransformMeth')
        TriggerServerEvent('esx_extradrugs:stopSellMeth')
        TriggerServerEvent('esx_extradrugs:stopHarvestWeed')
        TriggerServerEvent('esx_extradrugs:stopTransformWeed')
        TriggerServerEvent('esx_extradrugs:stopSellWeed')
        TriggerServerEvent('esx_extradrugs:stopHarvestOpium')
        TriggerServerEvent('esx_extradrugs:stopTransformOpium')
        TriggerServerEvent('esx_extradrugs:stopSellOpium')
end)

-- Weed Effect
RegisterNetEvent('esx_extradrugs:onPot')
AddEventHandler('esx_extradrugs:onPot', function()
...
RegisterNetEvent('esx_extradrugs:ReturnInventory')
AddEventHandler('esx_extradrugs:ReturnInventory', function(cokeNbr, cokepNbr, methNbr, methpNbr, weedNbr, weedpNbr, opiumNbr, opiumpNbr, jobName, currentZone)
    cokeQTE       = cokeNbr
    ...
    myJob         = jobName
    TriggerEvent('esx_extradrugs:hasEnteredMarker', currentZone)
end)
...
Citizen.CreateThread(function()
    while true do
        ...
        if isInMarker and not hasAlreadyEnteredMarker then
            ...
            TriggerServerEvent('esx_extradrugs:GetUserInventory', currentZone)
        end

        if not isInMarker and hasAlreadyEnteredMarker then
            hasAlreadyEnteredMarker = false
            TriggerEvent('esx_extradrugs:hasExitedMarker', lastZone)
        end
        ...
        if CurrentAction ~= nil then
            ...
            if IsControlJustReleased(0, 38) then
                if CurrentAction == 'coke_harvest' then
                    TriggerServerEvent('esx_extradrugs:startHarvestCoke')
                end
                if CurrentAction == 'coke_treatment' then
                    TriggerServerEvent('esx_extradrugs:startTransformCoke')
                end
                if CurrentAction == 'coke_resell' then
                    TriggerServerEvent('esx_extradrugs:startSellCoke')
                end
                if CurrentAction == 'meth_harvest' then
                    TriggerServerEvent('esx_extradrugs:startHarvestMeth')
                end
                if CurrentAction == 'meth_treatment' then
                    TriggerServerEvent('esx_extradrugs:startTransformMeth')
                end
                if CurrentAction == 'meth_resell' then
                    TriggerServerEvent('esx_extradrugs:startSellMeth')
                end
                if CurrentAction == 'weed_harvest' then
                    TriggerServerEvent('esx_extradrugs:startHarvestWeed')
                end
                if CurrentAction == 'weed_treatment' then
                    TriggerServerEvent('esx_extradrugs:startTransformWeed')
                end
                if CurrentAction == 'weed_resell' then
                    TriggerServerEvent('esx_extradrugs:startSellWeed')
                end
                if CurrentAction == 'opium_harvest' then
                    TriggerServerEvent('esx_extradrugs:startHarvestOpium')
                end
                if CurrentAction == 'opium_treatment' then
                    TriggerServerEvent('esx_extradrugs:startTransformOpium')
                end
                if CurrentAction == 'opium_resell' then
                    TriggerServerEvent('esx_extradrugs:startSellOpium')
                end
                CurrentAction = nil
            end
        end
