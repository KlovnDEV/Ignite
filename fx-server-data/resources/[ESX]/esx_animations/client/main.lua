...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, Keys['F11']) and IsInputDisabled(0) and not isDead then
			OpenAnimationsMenu()
		end

		if IsControlJustReleased(0, Keys['ESC']) and IsInputDisabled(0) and not isDead then
