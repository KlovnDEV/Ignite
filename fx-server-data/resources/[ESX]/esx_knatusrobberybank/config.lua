...
Banks = {
	["fleeca"] = {
		...
		reward = math.random(130000,175000), -- the random range of amount of money you will get for robbery this site
		nameofbank = "HSBC", --Visual Name that will be the site
