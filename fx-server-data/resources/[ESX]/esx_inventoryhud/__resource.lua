...
files {
  ...
  "html/img/items/556_rounds.png",
  "html/img/items/762_rounds.png",
  "html/img/items/weed.png",
  "html/img/items/weed_pooch.png",
  "html/img/items/ethereum.png",
  ...
  "html/img/items/ket.png",
  "html/img/items/xanax.png",
  "html/img/items/xanax_pooch.png",
  "html/img/items/valium.png",
  "html/img/items/valium_pooch.png",
