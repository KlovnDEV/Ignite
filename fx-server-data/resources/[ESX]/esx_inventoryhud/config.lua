...
Config.Shops = {
    ...
    WeaponShop = {
        ...
        Ammo = {
            {name = "9mm_rounds", weaponhash = "WEAPON_PISTOL", ammo = 1},
            {name = "shotgun_shells", weaponhash = "WEAPON_PUMPSHOTGUN", ammo = 1},
	    {name = '556_rounds', weaponhash = "WEAPON_CARBINERIFLE", ammo = 1},
	    {name = '762_rounds', weaponhash = "WEAPON_ASSAULTRIFLE", ammo = 1}
        },
        Items = {
