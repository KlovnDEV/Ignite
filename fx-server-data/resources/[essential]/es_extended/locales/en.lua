Locales['en'] = {
  ...
  -- Salary related
  ['received_salary'] = 'Your Salary has been paid into your account: ~g~$%s~s~',
  ['received_help'] = 'Your Universal Credit has been paid into your account: ~g~$%s~s~',
  ['company_nomoney'] = 'Sorry. The company you are working for is ~r~too poor~s~ to pay you.',
  ['received_paycheck'] = 'Secure Banking',
  ['bank'] = 'Fleeca',
