ESX.StartPayCheck = function()
	...
	function payCheck()
		...
		for i=1, #xPlayers, 1 do
			...
			if salary > 0 then
				if job == 'unemployed' then -- Is the player unemployed?
					...
					TriggerClientEvent('esx:showNotification', xPlayer.source, 'You might want to consider getting a Job.')
				elseif Config.EnableSocietyPayouts then -- Do they work for a society?
					TriggerEvent('esx_society:getSociety', xPlayer.job.name, function (society)
						if society ~= nil then -- Legal Job
